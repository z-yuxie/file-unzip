 ...
 * XZ格式解压策略实现
 * <p>
 * 该类继承自 {@link AbstractCompressedUnzipStrategy}，专门用于处理XZ格式的压缩文件解压。
 * 使用Apache Commons Compress库进行解压，支持标准的XZ格式。
 * </p>
 * <p>
 * 主要特点：
 * <ul>
 *   <li>支持标准XZ格式：兼容XZ Utils规范</li>
 *   <li>支持自动检测：可以自动识别XZ格式</li>
 ...
 * </p>
 * <p>
 * 注意：XZ格式通常用于压缩单个文件，如果解压后的数据是TAR格式，
 * 会自动切换到TAR解压策略进行处理。
 * </p>
 *
 * @author yuxie
 ...
 * @see UnzipConfig
 * @see org.apache.commons.compress.compressors.xz
 */
@Slf4j
public class XzUnzipStrategy extends AbstractCompressedUnzipStrategy {
    ...
    public XzUnzipStrategy(UnzipConfig unzipConfig) {
        super(unzipConfig, CompressionFormat.XZ);
    }
    
    /**
     * 创建压缩输入流
     * <p>
     * 使用Apache Commons Compress库创建XZ解压缩输入流。
     * </p>
     *
