 ...
 * LZ4格式解压策略实现
 * <p>
 * 该类继承自 {@link AbstractCompressedUnzipStrategy}，专门用于处理LZ4格式的压缩文件解压。
 * 使用Apache Commons Compress库进行解压，支持标准的LZ4格式。
 * </p>
 * <p>
 * 主要特点：
 * <ul>
 *   <li>支持标准LZ4格式：兼容LZ4压缩规范</li>
 *   <li>支持自动检测：可以自动识别LZ4格式</li>
 ...
 * </p>
 * <p>
 * 注意：LZ4格式通常用于压缩单个文件，如果解压后的数据是TAR格式，
 * 会自动切换到TAR解压策略进行处理。
 * </p>
 *
 * @author yuxie
 ...
 * @see UnzipConfig
 * @see org.apache.commons.compress.compressors.lz4
 */
@Slf4j
public class Lz4UnzipStrategy extends AbstractCompressedUnzipStrategy {
    ...
    public Lz4UnzipStrategy(UnzipConfig unzipConfig) {
        super(unzipConfig, CompressionFormat.LZ4);
    }
    
    /**
     * 创建压缩输入流
     * <p>
     * 使用Apache Commons Compress库创建LZ4解压缩输入流。
     * </p>
     *
